...
/**
 * SessionKeySigningResponse : the decryption service response for android SDK.
 *
 * @category    Class
...
class SessionKeySigningResponse
{
    ...
    static $setters = array(
        ...
        'session_signature' => 'setSessionSignature',
    ...
    static $getters = array(
        ...
        'session_signature' => 'getSessionSignature',
    ...
    /**
      * $session_signature the SessionSignature details.
      * @var string
      */
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->SessionSignature = isset($data["SessionSignature"])?$data["SessionSignature"]:"";
    ...
    /**
     * Gets session_signature
     * @return string
     */
    public function getSessionSignature()
    {
        return $this->SessionSignature;
    }

    /**
     * Sets session_signature
     * @param string $session_signature the SessionSignature details.
     * @return $this
     */
    public function setSessionSignature($session_signature)
    {

        $this->SessionSignature = $session_signature;
        return $this;
    }
